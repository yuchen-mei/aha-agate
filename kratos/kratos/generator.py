...
class Generator(metaclass=GeneratorMeta):
    ...
    @property
    def sync_reset_no_touch(self):
        """
        Tell not to touch the sync reset signal
        :return: ``True`` if auto_insert_sync_reset pass should be ignored...
        """
        return self.__generator.sync_reset_no_touch()

    @sync_reset_no_touch.setter
    def sync_reset_no_touch(self, value: bool):
        self.__generator.set_sync_reset_no_touch(value)

    @property
    def clk_en_no_touch(self):
        """
        Tell not to touch the clk_en signal
        :return: ``True`` if auto_insert_sync_reset pass should be ignored...
        """
        return self.__generator.clk_en_no_touch()

    @clk_en_no_touch.setter
    def clk_en_no_touch(self, value: bool):
        self.__generator.set_clk_en_no_touch(value)
