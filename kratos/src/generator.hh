...
public:
    ...
    std::shared_ptr<TaskStmtBlock> task(const std::string &func_name);
    ...
    bool sync_reset_no_touch() const { return sync_reset_no_touch_; }
    void set_sync_reset_no_touch(bool value) { sync_reset_no_touch_ = value; }

    bool clk_en_no_touch() const { return clk_en_no_touch_; }
    void set_clk_en_no_touch(bool value) { clk_en_no_touch_ = value; }
    ...
    // set the def parent clone. use it only if you know what you're doing
    void set_clone_ref(const std::shared_ptr<Generator> &ref);
    void copy_over_missing_ports(const std::shared_ptr<Generator> &ref);
...
private:
    ...
    bool sync_reset_no_touch_ = false;
    bool clk_en_no_touch_ = false;
