...
void init_generator(py::module &m) {
    ...
    generator.def("from_verilog", &Generator::from_verilog, py::return_value_policy::reference)
        ...
        .def("sync_reset_no_touch", &Generator::sync_reset_no_touch)
        .def("set_sync_reset_no_touch", &Generator::set_sync_reset_no_touch)
        .def("clk_en_no_touch", &Generator::clk_en_no_touch)
        .def("set_clk_en_no_touch", &Generator::set_clk_en_no_touch)
